...
export class ExploreComponent implements AfterViewInit {
  ...
  readonly cards: ExploreCard[] = [
    ...
    {
      title: 'Events',
      subtitle: 'Curated Celebrations on Water',
      cta: 'Learn More',
      route: '/events',
      imageSrc: 'assets/explore/events.jpeg',
      imageAlt: 'Friends celebrating on a yacht',
      area: 'events',
    },
    {
      ...
      imageAlt: 'Couple relaxing during a private celebration on water',
      area: 'celebrations',
    },
  ];
